...
const workflow = new StateGraph({
  ...
  .addNode("search", new RunnableLambda({ func: search }) as any)
  .addNode("curate", new RunnableLambda({ func: curate }) as any) 
  .addNode("write", new RunnableLambda({ func: write }) as any)
  .addNode("critique", new RunnableLambda({ func: critique }) as any)
  .addNode("revise", new RunnableLambda({ func: revise }) as any)
